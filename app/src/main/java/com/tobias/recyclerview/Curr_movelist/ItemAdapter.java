...
public class ItemAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements ItemTouchHelperAdapter {
    ...
    private ArrayList<Move> mPersonList;
    ...
    public ItemAdapter(Context context, ArrayList<Move> list, OnStartDragListener dragListner) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, final int i) {
        ...
        if (viewHolder instanceof VHItem) {
            ...
            Picasso.with(mContext)
                    .load(mPersonList.get(i).getImagecode())
    ...
    public void updateList(ArrayList<Move> list) {
        mPersonList = list;
